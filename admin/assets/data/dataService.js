(function (global) {
    ...
    async function deleteProduct(id) {
        ...
        global.HASTI_MOCK.PRODUCTS = DB.PRODUCTS;
        return delay(true);
    }
    ...
    async function deleteCategory(id) {
        ...
        global.HASTI_MOCK.CATEGORIES = DB.CATEGORIES;
        return delay(true);
    }
    ...
    async function deleteCollection(id) {
        ...
        global.HASTI_MOCK.COLLECTIONS = DB.COLLECTIONS;
        return delay(true);
    }
    ...
    async function deleteDiscount(id) {
        ...
        global.HASTI_MOCK.DISCOUNTS = DB.DISCOUNTS;
        return delay(true);
    }
    ...
    async function deleteBlogPost(id) {
        ...
        global.HASTI_MOCK.BLOG_POSTS = DB.BLOG_POSTS;
        return delay(true);
    }
    ...
    async function deleteReview(id) {
        ...
        global.HASTI_MOCK.REVIEWS = DB.REVIEWS;
        return delay(true);
    }
    ...
    async function deleteAdminUser(id) {
        ...
        global.HASTI_MOCK.ADMIN_USERS = DB.ADMIN_USERS;
        return delay(true);
    }
