...
export async function initProductForm() {
      ...
      function renderHeadActions() {
        ...
        document.getElementById('headActions').innerHTML =
          '<a class="btn btn--ghost btn--sm" href="/product/' + encodeURIComponent(state.id) +
        ...
        document.getElementById('dupBtn').addEventListener('click', async function () {
          ...
          setTimeout(function () {
            window.location.href = '/admin/products/' + encodeURIComponent(copy.id);
          }, 700);
        });
        ...
        document.getElementById('delBtn').addEventListener('click', async function () {
          ...
          setTimeout(function () { window.location.href = '/admin/products'; }, 700);
        });
      }
      ...
      async function save(status) {
        ...
        setTimeout(function () { window.location.href = '/admin/products'; }, 900);
      }
    }
