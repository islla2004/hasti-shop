/* ============================================================================
   ...
   ========================================================================== */
    ...
    var IMG = {
        abaya1: '/assets/01.webp',
        abaya1b: '/assets/01-2.webp',
        abaya2: '/assets/02.webp',
        abaya2b: '/assets/02-2.webp',
        shomiz: '/assets/03.webp',
        shomiz2: '/assets/03-1.webp',
        chador: '/assets/04.webp',
        chador2: '/assets/04 (1).webp',
        chadorItem: '/assets/chadorItem.webp',
        shall: '/assets/ShallItem.webp',
        kiff: '/assets/kiff.webp',
        set: '/assets/set.webp',
        shumizFull: '/assets/shumiz.webp',
        abbaItem: '/assets/AbbaItrm.webp',
        mazon: '/assets/mazon.webp'
    };
    ...
    var SETTINGS = {
        ...
        homepage: {
            heroSlides: [
                { image: '/assets/banner1replace.webp', title: 'کالکشن اربعین هستی', subtitle: 'پوششی شایسته برای سفر دل', link: '/chador' },
                { image: '/assets/banner2.webp', title: 'عبای دست‌دوز هستی', subtitle: 'ظرافت در هر دوخت', link: '/product/abaya-janan' },
                { image: '/assets/banner3.webp', title: 'ست‌های پیشنهادی', subtitle: 'هماهنگی کامل از سر تا کیف', link: '/chador' }
            ],
            authenticityBanner: { image: '/assets/AbbaItrm.webp', title: 'امضای اصالت هستی', text: 'هر محصول هستی با پارچه درجه یک و دوخت دست‌ساز تولید می‌شود.' },
    ...
    /* ============================== اعلان‌ها ============================= */
    var NOTIFICATIONS = [
        { id: 'nt_01', type: 'order', title: 'سفارش جدید ثبت شد', desc: 'سفارش HST-10260 به مبلغ ۱۲,۰۰۰,۰۰۰ تومان', at: 'چند لحظه پیش', link: '/admin/orders/HST-10260', read: false },
        { id: 'nt_02', type: 'stock', title: 'هشدار اتمام موجودی', desc: 'چادر نیلوفر — قد ۱۵۵ تنها ۱ عدد باقی مانده', at: '۲ ساعت پیش', link: '/admin/inventory', read: false },
        { id: 'nt_03', type: 'payment', title: 'قسط معوق', desc: 'قسط دوم سفارش HST-10251 سررسید شده است', at: '۵ ساعت پیش', link: '/admin/orders/HST-10251', read: false },
        { id: 'nt_04', type: 'review', title: 'نظر جدید در انتظار تایید', desc: '۴ نظر در انتظار بررسی هستند', at: 'دیروز', link: '/admin/reviews', read: false },
        { id: 'nt_05', type: 'ticket', title: 'تیکت فوری', desc: 'مشکل در پرداخت آنلاین — اولویت فوری', at: 'دیروز', link: '/admin/messages', read: true },
        { id: 'nt_06', type: 'restock', title: 'درخواست اطلاع از موجودی', desc: '۳ درخواست برای چادر نگین باران', at: '۲ روز پیش', link: '/admin/messages', read: true }
    ];
